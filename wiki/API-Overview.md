...
```
https://refferq-theta.vercel.app/api  # Development
...
```bash
curl -X POST https://refferq-theta.vercel.app/api/auth/send-otp \
...
```bash
curl -X POST https://refferq-theta.vercel.app/api/auth/verify-otp \
  -H "Content-Type: application/json" \
  -d '{
    "email": "user@example.com",
    "otp": "123456"
...
```bash
curl -X GET https://refferq-theta.vercel.app/api/auth/me \
...
```bash
curl -X POST https://refferq-theta.vercel.app/api/auth/register \
  -H "Content-Type: application/json" \
  -d '{
    "name": "John Doe",
...
```bash
curl -X POST https://refferq-theta.vercel.app/api/affiliate/referrals \
  -H "Content-Type: application/json" \
...
```bash
curl -X PUT https://refferq-theta.vercel.app/api/admin/referrals/456 \
  -H "Content-Type: application/json" \
...
```bash
curl -X GET https://refferq-theta.vercel.app/api/admin/dashboard \
  -H "Authorization: Bearer ADMIN_JWT_TOKEN"
```
...
```bash
curl -X POST https://refferq-theta.vercel.app/api/test/email \
  -H "Content-Type: application/json" \
  -d '{
    "type": "welcome",
    "to": "test@example.com"
